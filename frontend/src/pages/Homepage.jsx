  ...
  return (
    <>
      ...
      <div className="flex flex-1 h-[100vh] ">
        ...
        <div
          className="hidden xl:flex flex-col w-72 2xl:w-[350px] px-6 py-10 gap-10  overflow-scroll custom-scrollbar"
...
{
  /* <div className="flex flex-1 h-[100vh] ">
  <div className="flex flex-col flex-1  gap-10 overflow-auto py-10 px-5 md:px-8 lg:p-14 custom-scrollbar ">

  </div>
  <div className="hidden lg:flex flex-col w-72 2xl:w-465 px-6 py-10 gap-10  overflow-scroll custom-scrollbar">
