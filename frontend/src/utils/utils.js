export const companies = [
  ...
  "Infostrech Solutions Pvt Ltd",
  "S1 Services",
  "Ansys Fluent India Ltd",
  "Johnson Controls",
  "Siemens",
  "Aquatech Asia",
  "L & T Infotech",
  ...
  "Indian Army",
  "Quinnox",
  "Works Applications (Japan)",
  "Indian Navy",
  "Rishabh Instruments",
  "Xtremum Solutions Pvt Ltd",
  "Infibeam",
  ...
  "Amos (Allianz Managed Operations & Services Se (Amos) - India)",
  "Halliburton Offshore Services Inc",
  "Pubmatic",
  "Armacell India Pvt Ltd",
  "Harman International",
  "Rakuten",
  "Arxxus Technologies Ind Pvt Ltd",
  "Helium Consulting Pvt Ltd",
  "Rathivessels And Systems",
  "Audience Science India Pvt Ltd",
  "Hoonnar Tech",
  "Renishaw",
  "Auttomic Labs",
  "ILSI Group",
  ...
  "Inopen Technologies",
  "Soft Link",
  "Belzabar Design India Software Pvt Ltd",
  "Jacobs",
  ...
  "Borm Bruckmeier Infotech India Pvt Ltd.",
  "Knightfrank India Ltd",
  ...
  "Levia Technologies",
  "Techniche Engg Pvt Ltd.",
  "Caparo",
  "L'OR'EAL India pvt ltd",
  "Third I Technosoft Pvt Ltd",
  "CDK Global",
  "Magna Steyr",
  ...
  "Master Card",
  "Veda Engineering Pvt Ltd",
  "Cypress",
  "Mithi Software",
  "Versatile Equipments Pvt. Ltd.",
  "Digiapt Software Technologies Pvt Ltd.",
  "MUSCO Stampings (Mahindra)",
  "Vertex Software",
  "DLF Utilities Ltd",
  "Manhatten",
  "Vertis Microsystems",
  ...
  "Zuari",
  "Gallup",
  "Oriental Rubber Industries Ltd, Pune",
  "2 Coms Consulting Pvt. Ltd.",
  // New companies added from the provided list
  "eInfochips",
  "Kyndryl",
  "RKIT (RamKrishna IT)",
  "Accolite",
  ...
  "miniOrange (Xecurify Inc)",
  "AXA Business Services (THROUGH CALYXPOD)",
  "Hindustan Unilever (HUL)",
  "Nagarro",
  "Axxess",
  "HoltecAsia",
  "Neosoft Technologies",
  "Techniche Engineering Private Ltd",
  "Bank of America",
  "HSBC",
  "Neterwala",
  "Techverito",
  ...
  "CLSA",
  "Intelimek",
  "Posit Source Technologies Pvt Ltd.",
  "Vanderlande",
  "Cognizant marked as cognizant genc and cognizant genc elevate",
  "InVideo",
  "Principal Global",
  "Vayana",
  "Colgate Palmolive",
  ...
  "Jabil Manufacturing India Pvt Ltd",
  "Qualcomm",
  "Whiteklay",
  "Cummins",
  "JCB",
  ...
  "ZS associates",
  "KSB",
  "Ketto Online Ventures Pvt Limited",
  "Renishaw"
];
