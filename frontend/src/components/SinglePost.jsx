...
const SinglePost = ({ recommendedPosts, onBack }) => {
  ...
  if (!post) {
    return <div className="text-center text-gray-600 py-8">Post not found.</div>;
  }

  return (
    <div className="p-8">
      {/* Back Button and Single Post Details */}   
      <button type="button" class="bg-gray-800 text-white rounded-md border-r border-gray-100 hover:bg-red-700 hover:text-white mb-6 px-4 py-2" onClick={onBack}>
